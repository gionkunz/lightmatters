...
@Component({
  ...
  imports: [LmKickerComponent, LmButtonComponent, LmDiagramPlaceholderComponent],
  template: `
    <section
      class="grid grid-cols-2 items-center gap-x-14 border-b border-ink-faint px-16 pb-24 pt-[88px]"
    >
      <div>
        <lm-kicker class="mb-6 block" [opacity]="1">an interactive journey</lm-kicker>
        <h2
      ...
      <div class="relative">
        <div class="relative bg-paper-alt px-7 pb-[18px] pt-8 transition-colors duration-400">
          ...
          >
            You are always moving through spacetime at the speed of light. You only choose how
            to spend it.
          </div>
          <div class="flex justify-center">
            <lm-diagram-placeholder variant="single" [width]="500" [height]="380" />
          </div>
          <div class="mt-2 border-t border-ink-faint pt-3.5">
            <div class="flex flex-col gap-2">
              <div class="flex items-baseline justify-between">
                <span class="font-mono text-[10.5px] font-medium uppercase tracking-[0.18em] text-ink opacity-75">
                  v / c
                </span>
                <span class="font-mono text-[11.5px] text-ink opacity-65">0.62</span>
              </div>
              <div class="relative h-5">
                <div class="absolute inset-x-0 top-[9px] h-px bg-ink opacity-[0.22]"></div>
                <div
