...
@Component({
  selector: 'lm-ch5-constant-c-step-page',
  imports: [
    Step01Component,
    Step02Component,
    Step03Component,
  ...
  template: `
    @switch (stepNumber()) {
      @case (1) {
        <lm-ch5-constant-c-step-01 />
      }
      @case (2) {
        <lm-ch5-constant-c-step-02 />
      }
      @case (3) {
        <lm-ch5-constant-c-step-03 />
      }
      @case (4) {
        <lm-ch5-constant-c-step-04 />
      }
      @default {
        <div
