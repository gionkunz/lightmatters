...
import { STEP_05_FALL_THROUGH } from './step-05-fall-through';

@Component({
  selector: 'lm-ch7-step-05',
  imports: [
    LmStepFrameComponent,
    LmDiagramViewportComponent,
    LmNarratorChatFeedComponent,
  ...
  template: `
    <lm-step-frame
      ...
      [prevStepUrl]="'/chapter/12/step/4'"
      [nextStepUrl]="'/chapter/12/step/6'"
      [showPlayback]="true"
    ...
    >
      ...
      >
        ...
        <div class="flex min-h-0 flex-col bg-paper-alt px-[26px] py-[22px]">
          <lm-kicker [opacity]="0.55" class="mb-3.5">through the center</lm-kicker>
...
export class Step05Component implements OnInit, OnDestroy {
  ...
  protected readonly step = STEP_05_FALL_THROUGH;
