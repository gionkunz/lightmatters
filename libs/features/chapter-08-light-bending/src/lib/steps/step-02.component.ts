...
import { STEP_02_ONE_RAY } from './step-02-one-ray';

@Component({
  selector: 'lm-ch8-step-02',
  imports: [
    LmStepFrameComponent,
    LmDiagramViewportComponent,
    LmNarratorChatFeedComponent,
  ...
  template: `
    <lm-step-frame
      ...
      [prevStepUrl]="'/chapter/12/step/1'"
      [nextStepUrl]="'/chapter/12/step/3'"
      [showPlayback]="true"
    ...
    >
      ...
      >
        ...
        <div class="flex min-h-0 flex-col bg-paper-alt px-[26px] py-[22px]">
          <lm-kicker [opacity]="0.55" class="mb-3.5">one ray</lm-kicker>
...
export class Step02Component implements OnInit, OnDestroy {
  ...
  protected readonly step = STEP_02_ONE_RAY;
