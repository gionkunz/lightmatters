...
export const STEP_02_RECEDING_REDSHIFT: Step = {
  ...
  timeline: [
    ...
    {
      type: 'narrate',
      text: 'Watch the rings. Each is born at $c$, but the gaps between arrivals at $A$ grow wider — partly because $S$\'s clock runs slow (Chapter 7), partly because each pulse has farther to travel. $A$ hears the clock run **slow**.',
      pauseAfter: BEAT_PAUSE_MS,
    },
