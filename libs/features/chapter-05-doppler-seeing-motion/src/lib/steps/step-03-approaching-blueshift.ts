...
export const STEP_03_APPROACHING_BLUESHIFT: Step = {
  ...
  timeline: [
    ...
    {
      type: 'narrate',
      text: 'The wavefronts pile up — partly because $S$\'s clock runs fast in $A$\'s frame (Chapter 7), partly because each pulse has less distance to cover. $A$ hears ticks arriving closer together — the clock sounds **fast**.',
      pauseAfter: BEAT_PAUSE_MS,
    },
