...
@Component({
  selector: 'lm-ch9-mass-energy-step-page',
  imports: [
    Step01Component,
    Step02Component,
    Step03Component,
  ...
  template: `
    @switch (stepNumber()) {
      @case (1) {
        <lm-ch9-mass-energy-step-01 />
      }
      @case (2) {
        <lm-ch9-mass-energy-step-02 />
      }
      @case (3) {
        <lm-ch9-mass-energy-step-03 />
      }
      @case (4) {
        <lm-ch9-mass-energy-step-04 />
      }
      @case (5) {
        <lm-ch9-mass-energy-step-05 />
      }
      @case (6) {
        <lm-ch9-mass-energy-step-06 />
      }
      @default {
        <div
        ...
        >
          ...
          <a routerLink="/chapter/10/step/1">
