...
Chapter 2 Step 3 ("Bridge to light"): a **single-pulse** bridge to Chapter 3 — three observers, staged wavefront animation with narrative pauses at A and C reception, clock readouts, and predictions.
...
#### Scenario: Predictions gate continue to Chapter 3

- **WHEN** the timeline is complete and both predictions are selected
- **THEN** the footer continue control is enabled and labeled for the next chapter
- **AND** clicking it navigates toward Chapter 3 Step 1
...
- **AND** the footer continue control becomes enabled on or after this beat, labeled for the next chapter
