...
> Note: this chapter is **Chapter 5 "The same speed of light"** in the locked v1.0 map — after "Light and information" (3) and "The ether was wrong" (4), and before "Clocks & rulers" (6); it *resolves* the simultaneity puzzle planted in Chapter 3 rather than preceding it. Numbering and routes (`/chapter/:chapter/step/:step`) are owned by `reorder-chapters-and-route-scheme`. Scenarios reference steps by ordinal within this chapter.
