...
The `@lightmatters/design` public API SHALL export standalone Angular components: `LmWordmark`, `LmKicker`, `LmButton`, and `LmThemeToggle`. Each component SHALL read design tokens via Tailwind/CSS (not hard-coded hex in component TS).
