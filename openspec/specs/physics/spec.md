...
Pure physics functions for Light Matters: Lorentz factor, proper time, spatial speed, speed-budget readouts, relativistic energy and momentum, and mass–energy equivalence helpers shared by diagrams and narration.
## Requirements
