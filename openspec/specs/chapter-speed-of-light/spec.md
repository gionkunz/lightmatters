# chapter-speed-of-light Specification

## Purpose

Chapter 2 "The speed of light" — tangible magnitude of `c`, the causal speed limit, photon proper-time teaser, flash-and-detect measurement, the self-propagating EM wave, and Maxwell's prediction matching experiment. It sits after "Position, time, spacetime" (1) and before "The speed budget" (3). Numbering and routes (`/chapter/:chapter/step/:step`) are owned by `chapter-routing`; scenarios reference steps by ordinal within this chapter.
